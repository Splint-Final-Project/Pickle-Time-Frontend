import fistStudyImg from '@/assets/images/study.png';
import secondStudyImg from '@/assets/images/study2.png';
import fistExerciseImg from '@/assets/images/exercise.png';

import CarouselImg from './CarouselImg';
import { useState } from 'react';

const CAROUSEL_IMG_LIST = [
  {id: "1", img: fistStudyImg, content: "지금 제일 핫한\n피클 타임을\n찾아보세요!", semiContent: "친구와 함께\n책을 읽고 싶다면?"},
  {id: "2", img: secondStudyImg, content: "토론이 필요할 때도\n스터디를 찾으세요!", semiContent: "같은 목표로 같이 공부해요"},
